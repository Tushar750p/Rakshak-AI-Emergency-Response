const CACHE='rakshak-v2';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./public-dashboard.html','./command-center.html','./responder.html','./women-safety.html'];
